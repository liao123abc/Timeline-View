 ...
 */
public class TimeLineAdapter2 extends RecyclerView.Adapter<TimeLineViewHolder> {
    ...
    public TimeLineAdapter2(List<TimeLineModel> feedList, Orientation orientation, boolean withLinePadding) {
        mFeedList = feedList;
